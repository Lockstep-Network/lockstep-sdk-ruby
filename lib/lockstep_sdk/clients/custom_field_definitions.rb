...
class custom_field_definitions_client

    # Initialize the custom_field_definitions_client class with a lockstepsdk instance.
    ...
    # 
    # @param body [custom_field_definition_model] The Custom Field Definitions to create
