...
class AppEnrollments
    ...
    #  @param include [string] To fetch additional data on this object, specify the list of elements to retrieve. Available collections: App, CustomFields
    def retrieve_app_enrollment(include_param)
    ...
    def delete_app_enrollment(removeEnrollmentData)
        path = "/api/v1/AppEnrollments/#{id}"
        params = {:removeEnrollmentData => removeEnrollmentData}
    ...
    #  @param include [string] To fetch additional data on this object, specify the list of elements to retrieve. Available collections: App, CustomFields, LastSync
    ...
    def query_app_enrollments(filter, include_param, order, pageSize, pageNumber)
