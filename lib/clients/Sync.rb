...
module LockstepSdk
    class Client
        module Sync
            ...
            # @param include [string] To fetch additional data on this object, specify the list of elements to retrieve. Available collections: Details
            def retrieve_sync(include)
                path = "/api/v1/Sync/#{id}"
            ...
            def query_syncs(filter, include, order, pageSize, pageNumber)
