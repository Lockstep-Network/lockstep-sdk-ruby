...
module LockstepSdk
    class Client
        module Companies
            ...
            #  @param include [string] To fetch additional data on this object, specify the list of elements to retrieve. Available collections: Attachments, Contacts, CustomFields, Invoices, Notes, Classification
            def retrieve_company(include)
            ...
            def query_companies(filter, include, order, pageSize, pageNumber)
            ...
            #  @param pageSize [int32] The page size for results (default 200, maximum of 10,000)
            #  @param pageNumber [int32] The page number for results (default 0)
            def query_customer_summary(filter, include, order, pageSize, pageNumber)
