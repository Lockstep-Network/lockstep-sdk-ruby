...
module LockstepSdk
    class Client
        module Applications
            ...
            # @param include [string] To fetch additional data on this object, specify the list of elements to retrieve. Available collections: Notes, Attachments, CustomFields
            def retrieve_application(include)
            ...
            def query_applications(filter, include, order, pageSize, pageNumber)
