    ...
    class Client
        module Reports
            ...
            def cash_flow(timeframe)
                ...
                send_request(:get, path, nil, {timeframe})
            end
            ...
            def accounts_receivable_header(reportDate, companyId)
                ...
                send_request(:get, path, nil, {reportDate, companyId})
            end
            ...
            def invoice_aging_report(CompanyId, Recalculate, CurrencyCode, CurrencyProvider, Buckets)
                ...
                send_request(:get, path, nil, {CompanyId, Recalculate, CurrencyCode, CurrencyProvider, Buckets})
            end
            ...
            def attachments_header_information(companyId)
                ...
                send_request(:get, path, nil, {companyId})
            end
        end
    end
end
